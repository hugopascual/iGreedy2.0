...
areas_array=("North-Central" "North-East" "South-Central" "South-East" "West")
...
root_server_ip_direcction_selected="193.0.14.129"
log_file_name="Campaign_$(date +%F_%T).txt"
